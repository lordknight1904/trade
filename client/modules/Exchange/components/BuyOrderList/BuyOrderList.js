...
import { getBuyOrders } from '../../ExchangeReducer';
...
function mapStateToProps(state) {
  return {
    orders: getBuyOrders(state),
  };
}
BuyOrderList.propTypes = {
  dispatch: PropTypes.func,
  orderTableClick: PropTypes.func.isRequired,
  orders: PropTypes.array.isRequired,
};
BuyOrderList.contextTypes = {
  router: PropTypes.object,
};

export default connect(mapStateToProps)(BuyOrderList);
